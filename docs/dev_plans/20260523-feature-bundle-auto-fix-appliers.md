...
- Resolve the Codex base-dir question first (see Review Focus). Document the resolution idiom for each harness.
...
<!-- reviewed: 2026-05-23 @ 8ae7a0d6c62e7cb46f7fa49a1a3ea91d7b98bff5 -->
<!-- /review-plan writes the marker line above. Everything below is the workspace: edits here do NOT invalidate the marker. -->

## Progress

- [ ] Phase 1: Bundle build step + drift-guard parity test
- [ ] Phase 2: SKILL.md base-dir path convention (×4 mirrors)
