...
MANAGED_SKILLS="${MANAGED_SKILLS:-conduct content-draft content-review deep-review dev-plan fan-out grill plan-view release review-gauntlet review-plan rfc-finder show-me spec-compliance update-docs}"
