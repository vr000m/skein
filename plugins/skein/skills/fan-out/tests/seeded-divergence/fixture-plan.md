...
`plugins/skein/skills/fan-out/tests/run-seeded-divergence.sh` to prove the R6
mechanism deterministically: a contract-derived test fails against a divergent
