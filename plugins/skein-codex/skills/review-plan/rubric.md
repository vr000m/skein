...
- Every reconciled finding carries all five fields in the underlying data: `category`, `severity`, `finding`, `evidence`, `suggestion` — this holds regardless of how the finding is rendered
